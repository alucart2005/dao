      ...
      <div className="flex gap-2 items-center">
        <button
          ...
          style={{
            ...
            color:
              userVote === VoteType.FOR ? "white" : "var(--color-seaweed-200)",
          }}
          onMouseEnter={(e) =>
            !e.currentTarget.disabled &&
            userVote !== VoteType.FOR &&
            (e.currentTarget.style.backgroundColor = "var(--color-seaweed-800)")
          }
          onMouseLeave={(e) =>
            !e.currentTarget.disabled &&
            userVote !== VoteType.FOR &&
            (e.currentTarget.style.backgroundColor = "var(--color-seaweed-900)")
          }
        >
          A FAVOR
        </button>
